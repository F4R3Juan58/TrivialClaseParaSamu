...
public partial class Oceania : ContentPage
{
    ...
    {
        capitales = new string[] { "Canberra", "Wellington", "Suva", "Port Moresby", "Nukuʻalofa", "Apia", "Numea" };

        paises = new string[] { "Australia", "New Zealand", "Fiji", "Papua New Guinea", "Tonga", "Samoa","New Caledonia" };
    }
    ...
    {
        if (e.IsSelected && e.DataItem is ModeloOceania selected)
        {
